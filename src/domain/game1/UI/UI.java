package domain.game1.UI;

import domain.game1.UI.screenPanels.*;
 ...
 * It creates and displays the domain.game1.main JFrame, which contains the different panels
...
public class UI {
    ...
    // Initialize the domain.game1.main JFrame and CardLayout
    private void initializeUI() {
        ...
        // Add the domain.game1.main panel to the frame
        frame.add(mainPanel);
    ...
    /*
        * Show the domain.game1.main JFrame and the home screen
     */
    public void show() {
    ...
    public void showPanel(String panelName) {
        ...
        mainPanel.revalidate(); // Revalidate the domain.game1.main panel
        mainPanel.repaint(); // Repaint the domain.game1.main panel
    }
    ...
    private JPanel createBuildScreen() {
        // Create a JPanel as the domain.game1.main container for the Build Mode screen
    ...
    /*
        * Check if a panel with the given name is already added to the domain.game1.main panel
     */
