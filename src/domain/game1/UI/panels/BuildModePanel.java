...
import domain.game1.UI.panels.buildModeComponents.NavigationPanel;
import domain.game1.config.GameConfig;
import domain.game1.game.Hall;
import domain.game1.game.HallOfAir;
import domain.game1.game.HallOfEarth;
import domain.game1.game.HallOfFire;
import domain.game1.game.HallOfWater;
import domain.game1.handlers.BuildModeHandler;
import domain.game1.UI.panels.buildModeComponents.StructurePanel;
