package domain.game1.UI.panels;

import domain.game1.UI.ArrowAnimationView;
import domain.game1.UI.GridView;
import domain.game1.UI.PlayerView;
import domain.game1.UI.MonsterView;
import domain.game1.UI.renderers.GameRenderer;
import domain.game1.UI.screenPanels.SaveScreenPanel;
...
import domain.game1.enchantments.*;
import domain.game1.entity.playerObjects.Inventory;
import domain.game1.handlers.*;
import domain.game1.entity.Entity;
import domain.game1.entity.monsters.*;
import domain.game1.entity.playerObjects.Player;
import domain.game1.game.*;
import domain.game1.handlers.mouseHandlers.PlayModeMouseListener;
import domain.game1.UI.panels.sideBarComponents.HeartsLeftPanel;
import domain.game1.UI.panels.sideBarComponents.InventoryPanel;
import domain.game1.UI.panels.sideBarComponents.TimeLeftPanel;
import domain.game1.game.SearchRuneController;
import domain.game1.config.InformationExpertPattern.MonsterInfo;
import domain.game1.main.Main;
import domain.game1.main.PlayerInputHandler;
...
public class PlayModePanel extends JPanel implements Runnable {
    ...
    // This will be our domain.game1.main method which is running the Play mode screen
    @Override
    public void run() {
